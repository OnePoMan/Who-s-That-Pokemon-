          ...
          <div className="absolute top-12 left-0 bg-white rounded-lg shadow-xl border-2 border-pokemon-dark p-4 min-w-[200px] animate-fade-in">
            ...
            <div className="space-y-3">
              ...
              {roundResults.length > 0 && (
                <>
                  ...
                  <button
                    ...
                    className="w-full text-left text-sm font-bold text-pokemon-blue hover:opacity-80 transition-opacity"
                  >
              ...
              <button
                ...
                className="w-full text-left text-sm font-bold text-pokemon-red hover:opacity-80 transition-opacity"
              >
                Back to Home
              </button>
            </div>
